...
public class Cinema implements Serializable{
	...
	String displayCinema() {
		...
		return "\ninterfaces.Cinema Name: " + getCinemaName() + "\n"
			+  "interfaces.Cinema Code: " + getCinemaCode() + "\n"
			+  "interfaces.Cinema Type: " + getCinemaType() + "\n"
			+  "interfaces.Movie Timeslots: " + movieTimeslot.size() + "\n" + timeslot;
	}
}
