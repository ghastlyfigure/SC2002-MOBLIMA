...
public class MovieTimeSlotManager {
    ...
    /**
     * Read every Time Slot based on a certain value of a given attribute in the Database file and return them
     * @param choice                    Given attribute to be check (based on constant as defined)
