...
import controllers.MovieListManager;
import controllers.MovieManager;
import controllers.MovieSessionManager;
import interfaces.Cinema;
import interfaces.CinemaType;
import interfaces.SeatList;
...
public class MainMenuUI {
	...
	private static void startSystem() {
		...
		if(cineplexManager.getAllCineplex().size() == 0){
			...
			cineplexManager.createCineplex("Orchard Movies interfaces.Cineplex", cinemasOne);
			cineplexManager.createCineplex("Sentosa Beach interfaces.Cineplex", cinemasTwo);
			cineplexManager.createCineplex("interfaces.Movie Base interfaces.Cineplex", cinemasThree);
		}
	}
